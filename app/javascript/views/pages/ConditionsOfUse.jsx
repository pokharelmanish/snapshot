...
const ConditionsOfUse = () => (
  <div className='container'>
    ...
    <ul>
      <li><a href='#personal_information_and_choice'>Personal Information and Choice</a></li>
      <li><a href='#special_note_about_children'>A Special Note about Children</a></li>
      <li><a href='#information_collected'>Information Collected and How it is Used</a></li>
      <li><a href='#what_happens_to_info'>What Happens to Information You Submit to Us</a></li>
      <li><a href='#use_of_internet_request'>Use of Internet Request for Assistance Form Information</a></li>
    ...
    <h3 id='personal_information_and_choice'>PERSONAL INFORMATION AND CHOICE</h3>
    ...
    <p>According to Government Code § 11015.5., &quot;electronically collected personal information&quot; means any information that is maintained by an agency that identifies or describes an individual user, including, but not limited to, his or her name, social security number, physical description, home address, home telephone number, education, financial matters, medical or employment</p>
    <p>history, password, electronic mail address, and information that reveals any network location or identity, but excludes any information manually submitted to a State agency by a user, whether electronically or in written form, and information on or relating to individuals who are users, serving in a business capacity, including, but not limited to, business owners, officers, or principals of that business.</p>
    ...
    <h3 id='special_note_about_children'>A SPECIAL NOTE ABOUT CHILDREN</h3>
    ...
    <h3 id='information_collected'>INFORMATION COLLECTED AND HOW IT IS USED</h3>
    ...
    <h3 id='what_happens_to_info'>WHAT HAPPENS TO INFORMATION YOU SUBMIT TO US?</h3>
    ...
    <h3 id='use_of_internet_request'> USE OF INTERNET REQUEST FOR ASSISTANCE FORM INFORMATION</h3>
    ...
    <p>1. The e-mail address and contents of the e-mail; and</p>
    <p>2. Information volunteered in response to the survey.</p>
    ...
    <h3 id='if_you_send_us_email'>IF YOU SEND US E-MAIL</h3>
    ...
    <h3 id='personal_information'>PERSONAL INFORMATION</h3>
    ...
    <h3 id='automatic_collection_of_info'>AUTOMATIC COLLECTION OF INFORMATION/COOKIES</h3>
    ...
    <h3 id='links_to_other_sites'>LINKS TO OTHER SITES</h3>
